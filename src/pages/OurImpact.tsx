...
const StatCard: React.FC<StatCardProps> = ({ stat, description }) => {
  return (
    <div className="flex flex-col justify-end items-center gap-2">
      ...
      {/*stat subhead*/}
      <div>
        <h2 className="text-center text-white max-w-[276px]">{description}</h2>
      </div>
    </div>
  );
};
      ...
      <div className="grid grid-rows-[auto_auto_auto_auto] gap-4">
        ...
        >
          ...
          <h2 className="text-lg md:text-2xl text-white">
            {" "}
            Discover the power of wraparound care
          </h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start gap-6 md:gap-12 py-8 md:py-[72px] px-6 md:px-[120px]">
          ...
          <div className="w-full md:w-1/2">
            ...
            <h2 className="text-lg md:text-2xl text-white text-left mt-6 md:mt-10">
              {" "}
              Building a team around the person — not sending them through the
              maze of services alone. It's about connecting housing, healthcare,
              benefits, and support into one coordinated, human-centered plan.
              Real help, rooted in trust and dignity.
            </h2>
          </div>
        ...
        <div
          className="flex flex-row justify-between items-start gap-12
               py-8 md:py-[72px]
               px-6 md:px-[120px]
               min-h-[519px]
               shrink-0 bg-cover bg-center mt-60"
        >
          ...
          <div className="w-1/2 flex flex-col items-start gap-6">
            {/*Eyebrow*/}
            <h2 className="text-white text-sm font-semibold tracking-wider text-left">
              STORIES OF SUCCESS
            </h2>
            {/*Whose story*/}
            ...
            <h2 className="text-white text-lg text-left">
              When we first met Casey, he was carrying everything he owned in
              two plastic bags. Today, he's a peer advocate helping others
              navigate their own paths forward.
              <br />
              <br />
              "The difference wasn't just the resources," Casey says. "It was
              being treated like a person with something to offer, not just
              someone with problems to fix."
            </h2>
            {/*Buttons*/}

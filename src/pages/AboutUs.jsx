...
const HistoryPanel = ({
    ...
    <div className="flex flex-col lg:flex-row justify-between items-start gap-12 w-full">
        {/* Text content */}
        <div className={`w-full lg:w-1/2 flex flex-col items-start gap-6 ${imagePosition === 'left' ? 'lg:order-2' : 'lg:order-1'}`}>
            {/* Eyebrow years */}
        ...
        {image && (
            <div className={`w-full lg:w-1/2 flex flex-col items-start gap-4 ${imagePosition === 'left' ? 'lg:order-1' : 'lg:order-2'}`}>
                <img
                    src={image}
                    alt={title}
        ...
        <div className="py-6">
            ...
            >
                <div className="flex-1">
                    <h3 className="text-white text-xl font-semibold text-left">{question}</h3>
                </div>
            ...
            {isOpen && (
                <div className="mt-4 text-white text-lg text-left ">
                    {answer}
                </div>
            )}
        </div>
...
const faqData = [
    {
        ...
        answer: "The Rehumanization Project is a nonprofit organization dedicated to providing housing support, food assistance, mental health services, and employment resources to individuals experiencing homelessness and economic hardship. Our mission is to create long-term, "
...
const historyData = [
    {
        startYear: "Feb. 2025",
        title: "Foundation",
        description: "The Rehumanization Project was founded on the belief that homelessness is not an identity, but a temporary crisis that can be overcome with the right support. What began as a grassroots effort between our founder and community partners to provide direct outreach and emergency aid has evolved into a comprehensive support network grounded in the wraparound care model—a proven approach that stabilizes individuals by addressing housing, mental health, addiction recovery, and employment support together.",
        ...
        <div className="w-screen min-h-screen bg-[#060A1F] overflow-x-hidden" style={{fontFamily: 'Figtree'}}>
            <div className="grid grid-rows-[auto_auto_auto_auto] gap-4">
                ...
                >
                    ...
                    <h2 className="text-2xl text-white">Learn about our mission, vision, and history.</h2>
                </div>
            ...
            <div className="py-[72px] px-6 md:px-[120px] bg-[#040E2E]">
                <div className="flex flex-col items-start w-full">
                    <h1 className="text-white text-4xl font-bold text-left mb-12 relative z-10">Ethan's Story</h1>
            ...
            <div className="py-[72px] px-6 md:px-[120px] bg-[#060A1F]">
                <div className="mb-16">
                    <h1 className="text-white text-5xl font-bold text-left mb-4">Our History</h1>
                    <p className="text-white text-lg text-left">
                        The Rehumanization Project's journey reflects our commitment to partnership-centered care and systemic change.
                    </p>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-end items-start gap-6 relative">
                    <div className="relative w-full">
                        ...
                        <div
                            ...
                            style={{
                                background: 'linear-gradient(to top, rgba(4, 14, 46, 0.9), transparent)'
                            }}
                        ></div>
                    </div>
                </div>
            ...
            <div className="py-[72px] px-6 md:px-[120px]">
                <h1 className="text-white text-4xl font-bold text-left mb-8">Frequently Asked Questions</h1>
